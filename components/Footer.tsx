...
const REMIX_IDEAS = [
    "to try different winter outfits.",
    "to design your own clothing line.",
    "to create a new look for a special occasion.",
    "to see yourself in different historical fashion.",
    "to generate a custom lookbook.",
    "to turn your fashion sketches into reality.",
];
